// Pinapalitan nito ang sarili ni Flutter na bootstrap.
//
// Dalawang dahilan. Una, deprecated na ang pagpaparehistro ng service worker
// sa pamamagitan ng bootstrap ng Flutter — babala mismo nito iyon. Pangalawa,
// ang `flutter_service_worker.js` na ginagawa nito ngayon ay tinatanggal na
// lang ang sarili at wala nang iniimbak, kaya walang offline.
//
// Sarili nating `sw.js` ang gamit dito. Tingnan doon kung paano.

// Pinakauna ito sa lahat, bago pa ang engine ng Flutter. Ang canvaskit ang
// pinakamabigat na kailangang maimbak, at maaga itong hinihingi — kung
// `window.load` pa tayo maghihintay, tapos na itong nakuha bago pa man
// magkaroon ng cache.
if ('serviceWorker' in navigator) {
  navigator.serviceWorker.register('sw.js').catch(function (e) {
    // Walang offline kapag nabigo, pero tuloy pa rin ang app.
    console.warn('Hindi naitala ang service worker:', e);
  });
}
...
// Walang `serviceWorkerSettings` — sinasadya. Huwag nang hayaang magparehistro
// si Flutter; iisa lang ang service worker na kayang manatili sa isang scope,
// at ang atin ang gusto nating manalo.
